...
namespace AddressBookApplication.Controllers
{
    ...
    public class AddressBookController : ControllerBase
    {
        ...
        /// <summary>
        /// Method is used to fetch all the AddressBook Entries
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        public async Task<ActionResult<IEnumerable<AddressBookEntity>>> GetAllContacts()
        {
            ResponseModel<IEnumerable<AddressBookEntity>> response = new ResponseModel<IEnumerable<AddressBookEntity>>();
        ...
        {
            ResponseModel<AddressBookEntity> response = new ResponseModel<AddressBookEntity>();
        ...
        /// <returns>?</returns>
        [HttpPost]
        public async Task<ActionResult<AddressBookEntity>> AddContact([FromBody] AddressBookEntity contact)
        {
            ResponseModel<AddressBookEntity> response = new ResponseModel<AddressBookEntity>();
            if (contact == null)
            {
